...
plotStack = subset(view,paste0(c("I","ML","MH"),s))
plotStack[[1]] = plotStack[[1]]*countryR
plotStack[[2]] = plotStack[[2]]*countryR
plotStack[[3]] = plotStack[[3]]*countryR
names(plotStack)= paste0(c("I","ML","MH"),s)
pdf(paste0(gsub("rasters","figures",resultDir,fixed=T),"/fig5MapsRawBig",selectTerm,"std",doStandardization,".pdf"),
    width=8,height=3)
...
plotStack = subset(view,paste0(c("I","ML","MH","BH"),s))
pdf(paste0(gsub("rasters","figures",resultDir,fixed=T),"/fig5MapsRaw",selectTerm,"std",doStandardization,".pdf"),
    width=8,height=3)
par(mar=c(0,0,0,0), oma=c(0,0,0,0))
...
plotStack = subset(cc,paste0(c("I","ML","MH","BH"),s))
